...
class Movable {
      public:
             Movable(int x, int y, int width, int height, int velX, int velY, BITMAP *buffer, BITMAP *picture);
             Movable(int x, int y, int width, int height, int velX, int velY, BITMAP *buffer, BITMAP *picture, int dir);
...
Movable::Movable(int x, int y, int width, int height, int velX, int velY, BITMAP *buffer, BITMAP *picture) {
                     locationX=x;
                     locationY=y;
                     wid=width;
                     hgt=height;
...
Movable::Movable(int x, int y, int width, int height, int velX, int velY, BITMAP *buffer, BITMAP *picture, int dir) {
                     locationX=x;
                     locationY=y;
                     wid=width;
                     hgt=height;
...
void Movable::display() {
     draw_sprite(buf, pic, locationX, locationY);
}
...
void Movable::setLocX(int x) {
     locationX=x;
}

void Movable::setLocY(int y) {
     locationY=y;
}

void Movable::changeLocX(int x) {
     locationX+=x;
}

void Movable::changeLocY(int y) {
     locationY+=y;
}
...
void Movable::drawHitBox() {
     rect(buf, locationX, locationY, locationX+wid, locationY+hgt, makecol(0, 0, 0));
}
