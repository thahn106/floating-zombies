/*
Creature.h
These objects extend Movable objects. They will be extended by the Player and the Enemy.
*/
...
class Creature : public Movable {
      public:
             Creature(int x, int y, int x2, int y2, int velX, int velY, BITMAP *buffer, BITMAP *picture);
...
Creature::Creature(int x, int y, int x2, int y2, int velX, int velY, BITMAP *buffer, BITMAP *picture)
